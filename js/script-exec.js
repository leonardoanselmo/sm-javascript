...
const abaixo501 = crazyNumbers.reduce((acc, crazyNumber) => {
  if(crazyNumber < 501){
    return acc + 1
  }
  return acc
...
const filmesAntes2000 = tarantinoMovies.filter(tarantinoMovie => tarantinoMovie.release < 2000)
...
const serieNome = tvShows.map(tvShow => tvShow.name)

console.log(serieNome);
